                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white p-5 rounded-lg shadow border border-gray-200">
                        ...
                        <div className="font-mono text-sm">
                            <div><span className="text-blue-600">class</span> <span className="text-purple-600">Student</span> <span className="text-blue-600">implements</span> Comparable&lt;Student&gt; {'{'}</div>
                            <div className="ml-4"><span className="text-blue-600">private</span> String name;</div>
                            <div className="ml-4"><span className="text-blue-600">private</span> LocalDate birthDate;</div>
                            <div className="ml-4"></div>
                            <div className="ml-4"><span className="text-blue-600">public</span> Student(String name, LocalDate birthDate) {'{'}</div>
                            <div className="ml-8">this.name = name;</div>
                            <div className="ml-8">this.birthDate = birthDate;</div>
                            <div className="ml-4">{'}'}</div>
                            <div className="ml-4"></div>
                            <div className="ml-4 text-gray-500">{'// Порівнюємо за датою народження'}</div>
                            <div className="ml-4 text-gray-500">@Override</div>
                            <div className="ml-4"><span className="text-blue-600">public int</span> compareTo(<span className="text-purple-600">Student</span> other) {'{'}</div>
                            <div className="ml-8"><span className="text-blue-600">return</span> this.birthDate.compareTo(other.birthDate);</div>
                            <div className="ml-4">{'}'}</div>
                            <div>{'}'}</div>
                    ...
                    <div className="bg-white p-5 rounded-lg shadow border border-gray-200">
                        ...
                        <div className="font-mono text-sm space-y-3">
                            ...
                            <div className="border-t pt-3">
                                <div className="text-gray-500">{'// За датою народження (від старших до молодших)'}</div>
                                <div>Comparator&lt;Student&gt; byBirthDateAsc = (s1, s2) -&gt;</div>
                                <div className="ml-4">s1.birthDate.compareTo(s2.birthDate);</div>
                            </div>

                            <div className="border-t pt-3">
                                <div className="text-gray-500">{'// За датою народження (від молодших до старших)'}</div>
                                <div>Comparator&lt;Student&gt; byBirthDateDesc = (s1, s2) -&gt;</div>
                                <div className="ml-4">s2.birthDate.compareTo(s1.birthDate);</div>
                            </div>

                            <div className="border-t pt-3">
                                <div className="text-gray-500">{'// Комбіноване: спочатку за датою народження, потім за іменем'}</div>
                                <div>Comparator&lt;Student&gt; combined =</div>
                                <div className="ml-4">Comparator.comparing((Student s) -&gt; s.birthDate)</div>
                            ...
                            <div className="border-t pt-3">
                                ...
                                <div>students.sort(byBirthDateAsc);</div>
            ...
            content: (
                <div className="space-y-6">
                    ...
                    <div className="bg-white p-5 rounded-lg shadow border border-gray-200">
                        ...
                        <div className="font-mono text-sm">
                            <div><span className="text-blue-600">class</span> <span className="text-purple-600">Person</span> <span className="text-blue-600">implements</span> Comparable&lt;Person&gt; {'{'}</div>
                            <div className="ml-4"><span className="text-blue-600">private</span> String name;</div>
                            <div className="ml-4"><span className="text-blue-600">private</span> LocalDate birthDate;</div>
                            <div className="ml-4"></div>
                            <div className="ml-4 text-gray-500">{'// Природне сортування за датою народження'}</div>
                            <div className="ml-4 text-gray-500">@Override</div>
                            <div className="ml-4"><span className="text-blue-600">public int</span> compareTo(<span className="text-purple-600">Person</span> other) {'{'}</div>
                            <div className="ml-8"><span className="text-blue-600">return</span> this.birthDate.compareTo(other.birthDate);</div>
                            <div className="ml-4">{'}'}</div>
                            <div>{'}'}</div>
                            <div className="mt-3 text-gray-500">{'// Альтернативне сортування за іменем'}</div>
                    ...
                    <div className="bg-white p-5 rounded-lg shadow border border-gray-200">
                        ...
                        <div className="font-mono text-sm space-y-4">
                            <div className="bg-blue-50 p-3 rounded">
                                ...
                                <div className="ml-4"><span className="text-blue-600">private</span> <span className="text-purple-600">String</span> cardNumber;</div>
                                <div className="ml-4"></div>
                            ...
                            <div className="bg-green-50 p-3 rounded">
                                ...
                                <div className="ml-4"><span className="text-blue-600">private</span> <span className="text-purple-600">String</span> email;</div>
                                <div className="ml-4"></div>
                                <div className="ml-4">@Override</div>
                                <div className="ml-4"><span className="text-blue-600">public void</span> processPayment(<span className="text-blue-600">double</span> amount) {'{'}</div>
